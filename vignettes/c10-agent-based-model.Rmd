...
cb <- brick(stack(gti4, lc4))#, filename = "external/ext_data/cropland-md4.tif",             overwrite = TRUE)
...
![figure](../inst/paper/figures/abm-selected-districts.pdf)
...
```{r, eval = FALSE}
dssat <- fread(spathfunc("abm/dssat-yields.csv", ))
