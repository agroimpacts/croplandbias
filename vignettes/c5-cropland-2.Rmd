---
title: "Cropland Percentage Bias and Accuracy, part II"
author: "Lyndon Estes"
date: "`r Sys.Date()`"
output: 
...
load(fp(p_data, "d_grid_abs.rda"))  # actual diffence grids
load(fp(p_data, "bias_stats.rda"))  # bias statistics
load(fp(p_data, "bias_stats_gti.rda"))  # bias statistics
load(fp(p_data, "agg_cropland.rda"))  # aggregated cropland
...
```{r, eval = FALSE}
namask <- raster(fp(p_data, "namask.tif"))
...
pdf(fp(p_fig, "bias_map.pdf"), height = 7, width = 7)
...
<p align="center"><img src="../inst/paper/figures/bias_map.pdf" width="400px"></p> 
...
paths <- dir(p_data, "cover*.*sum_mask.tif$", full.names = TRUE)
...
pdf(fp(p_fig, "cropland_bias_main.pdf"), height = 7, width = 7)
...
```{r, eval = FALSE}
load(fp(p_data, "lcf_out2011.rda"))
