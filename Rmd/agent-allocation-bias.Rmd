...
yst <- seq(0.005, 0.105, 0.07 / 3)
xy <- cbind(grconvertX(rep(0.55, 5), from = "ndc"), 
            grconvertY(yst, from = "ndc"))
text(x = xy[2:5, 1], y = xy[2:5, 2], labels = c(mcap),# "District"), 
     #srt = 90, #pos = 2, 
     #adj = c(-1, 1), 
     pos = 2, col = c(scols), cex = cx[1])
dev.off()
