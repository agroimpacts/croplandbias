...
pdf(full_path(p_fig, "agent-bias.pdf"), height = 3, width = 5)
cx <- c(0.7, 0.8, 0.6)
...
par(mfrow = c(1, 2), mar = c(2, 2, 0.5, 0), mgp = c(0.75, 0.05, 0), 
