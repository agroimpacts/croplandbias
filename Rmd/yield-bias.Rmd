...
caption <- paste("Biases and mean absolute errors (MAE) in disaggregated maize",                  "yield and production (calculated from disaggregated yield",                    "and harvested area estimates)", 
