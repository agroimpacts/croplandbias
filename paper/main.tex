...
%Top-down accuracy assessments are also made from  "sanity checks" made in comparison to aggregated survey data. 
%
%
%
%This allows us to quantify between-map discrepancies  \cite[e.g.][]{fritz_comparison_2010, kaptue_tchuente_comparison_2011}, or to understand map fidelity to country-level statistics \cite[e.g.][]{fritz_comparison_2010}, but offers little direction for how to arrive at a true number.
%
%
%
%In practice, this means that we have an incomplete understanding of map error, and 
%
%
%
%
%There are also well-defined guidelines for quantifying and accounting for map accuracy \cite{stehman_global_2012, olofsson_good_2014, olofsson_good_2014}. However, inadequate assessment of map error and their impacts on subsequent analyses remains quite common within the community of landcover map users \cite{olofsson_making_2013,olofsson_good_2014}. There is also an open question  
%
%or from top-down "sanity checks" made in comparison to aggregated survey data. 
